...
from ..serializers import TweetSerializer, TweetActionSerializer, TweetCreateSerializers
...
def tweet_create_view(request, *args, **kwargs):
    serializer = TweetCreateSerializers(data=request.data or None)
...
def tweet_list_view(request, *args, **kwargs):
    ...
    username = request.GET.get('username')  # ?username=nacho
    if username != None:
